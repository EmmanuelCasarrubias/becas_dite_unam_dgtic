#!/usr/bin/env python3
"""
SISTEMA DE MONITOREO Y SEGURIDAD PARA CENTROS DE DATOS Y TELECOMUNICACIONES
...
class Config:
    ...
    ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'CAMBIAR_CONTRASEÑA_DGTIC_2026!')
    BECARIO_PASSWORD = os.environ.get('BECARIO_PASSWORD', 'CAMBIAR_CONTRASEÑA_BECARIO_2026!')
